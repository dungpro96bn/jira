<?php require __DIR__ . '/../layouts/header.php'; ?>
    ...
    <main class="dashboard-main dashboard-create-task-page">
        <section class="dashboard-topbar">
            ...
            <div class="dashboard-topbar-actions">
                ...
                <?php endif; ?>
                <a href="/board" class="dashboard-button dashboard-button-primary">Open Tasks</a>
            </div>
        </section>

        <section class="panel create-task-dashboard-panel">
            <div class="panel-header">
                <div>
                    <h3 class="panel-title">New Jira Task</h3>
                    <p class="panel-subtitle">Fill in task details, description, attachments, assignee, labels, priority, and due date.</p>
                </div>
            </div>
            <div class="panel-body">
                <div id="createTask" class="dashboard-form-surface">
